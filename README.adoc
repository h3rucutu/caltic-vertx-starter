= Caltic Vert.x Starter | image:https://travis-ci.org/h3rucutu/caltic-vertx-starter.svg?branch=develop["Build Status", link="https://travis-ci.org/h3rucutu/caltic-vertx-starter"]
